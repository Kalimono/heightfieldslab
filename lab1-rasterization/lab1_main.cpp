...
void initialize()
{
	...
	const float colors[] = {
		...
		0.2f, 0.8f, 0.2f, // White
		0.4f, 0.8f, 0.4f, // White
		0.6f, 0.8f, 0.6f  // White
	};
	...
	const float colors2[] = {
		//   R     G     B
		0.2f, 0.0f, 0.2f, // White
		0.4f, 0.0f, 0.4f, // White
		0.6f, 0.0f, 0.6f  // White
	};
	GLuint colorBuffer2;
	...
	//glGenBuffers(1, &positionBuffer3);
	//glBindBuffer(GL_ARRAY_BUFFER, positionBuffer3);
	//glBufferData(GL_ARRAY_BUFFER, labhelper::array_length(positions3) * sizeof(float), positions3,
	//	GL_STATIC_DRAW);
	...
	//glBufferData(GL_ARRAY_BUFFER, labhelper::array_length(colors3) * sizeof(float), colors3, GL_STATIC_DRAW);
	//glGenVertexArrays(1, &vertexArrayObject);
	//glBindVertexArray(vertexArrayObject);
	//glBindBuffer(GL_ARRAY_BUFFER, positionBuffer3);
	//glVertexAttribPointer(0, 3, GL_FLOAT, false /*normalized*/, 0 /*stride*/, 0 /*offset*/);
